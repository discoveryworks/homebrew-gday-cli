class Gday < Formula
  ...
  url "https://github.com/discoveryworks/gday-cli/archive/v1.0.1.tar.gz"
  sha256 "c9488f71642e2ec75f8ec206ea5f78f962ba6802a160a9eb8f23ecdd96f57e67"
  license "MIT"
  version "1.0.1"
  ...
  test do
    ...
    assert_match "VERSION: 1.0.1", shell_output("#{bin}/gday --help")
  end
end