class Gday < Formula
  ...
  url "https://github.com/discoveryworks/gday-cli/archive/v1.7.1.tar.gz"
  sha256 "0e18677993d1dfcfbf6ac2d1cc08e34684b1548a7d32c3981a337c8f96a0cb99"
  license "MIT"
  version "1.7.1"
  ...
  test do
    ...
    assert_match "VERSION: 1.7.1", shell_output("#{bin}/gday --help")
  end
end