class Gday < Formula
  ...
  url "https://github.com/discoveryworks/gday-cli/archive/v1.1.3.tar.gz"
  sha256 "f3d3b309d762660efd36e1e2996ffc48d6b0fe08dfbaba4eb3d5d426518153e2"
  license "MIT"
  version "1.1.3"
  ...
  test do
    ...
    assert_match "VERSION: 1.1.3", shell_output("#{bin}/gday --help")
  end
end